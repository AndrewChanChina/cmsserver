    		...
    		<div id="main_bg">
    			...
    			<div id="content">
    				...
    				<form action="" method="post">
    					...
    					<input id="url" name="url" size="64" type="text" style="display: inline;"> &nbsp; <input name="commit" type="submit" value="Extract" style="display: inline;"> &nbsp; <a href="/users/test886/hub/new">Skip to advanced</a>
						</p>
    				</form>
    				<div class="clear"></div>
    			</div>
