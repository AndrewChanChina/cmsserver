...
<html>
  ...
  <body>
    	...
    	<% String type = request.getParameter("type");
    		   if(type.equals("qq")){
    	%>
    	<li><a href="#"><img src="./images/im/liaotian1.jpg" width="80" height="80"><span>QQ</span></a></li>
    	<li><a href="#"><img src="./images/im/liaotian2.jpg" width="80" height="80"><span>MSN</span></a></li>
    	<li><a href="#"><img src="./images/im/liaotian3.jpg" width="80" height="80"><span>Skype</span></a></li>
    	<li><a href="#"><img src="./images/im/liaotian4.jpg" width="80" height="80"><span>飞信</span></a></li>
    	<li><a href="#"><img src="./images/im/liaotian5.jpg" width="80" height="80"><span>阿里旺旺</span></a></li>
    	<%
    	}else if(type.equals("email")){
    	 %>
    	<li><a href="#"><img src="../images/im/liaotian1.jpg" width="80" height="80"><span>QQ邮箱</span></a></li>
