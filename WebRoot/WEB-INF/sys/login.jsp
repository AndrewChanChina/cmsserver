    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="423" height="280" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><img src="./images/login/ltop.jpg" /></td>
              </tr>
              <tr>
                <td><img src="./images/login/llogo.jpg" /></td>
              </tr>
            </table></td>
          <td width="40" align="center" valign="bottom"><img src="./images/login/line.jpg" width="23" height="232" /></td>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="90" align="center" valign="bottom"><img src="./images/login/ltitle.jpg" /></td>
              </tr>
              <tr>
                <td>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
                    ...
                    <tr>
                      <td height="40" colspan="2" align="center">
					    <input type="image" src="./images/login/login.jpg" name="submit" />
                        &nbsp; &nbsp; <img name="reg" style="cursor: pointer" src="./images/login/reset.jpg" onclick="" /> </td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
