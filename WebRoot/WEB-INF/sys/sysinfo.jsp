...
<div class="body-box">
	<div class="rhead">
		<div class="rpos">当前位置: 基础数据 - 列表</div>
			<form class="ropt">
			</form>
		<div class="clear"></div>
	</div>
	
	<form id="jvForm" action="addSysInfo.do" method="post" style="padding:5px 0 0 5px">
		键:<input type="text" name="sysInfoKey" class="required" maxlength="255" style="width:120px"/>
		值:<input type="text" name="sysInfoValue" class="required" maxlength="255" style="width:500px"/>
	...
	<form id="tableForm" method="post">
		...
		<table class="pn-ltable" style="" width="100%" cellspacing="1" cellpadding="0" border="0">
			...
			%>
				<tr>
					<td><input type="checkbox" name="ids" value="<%=info_id%>"/></td>
					<td><%=i+1%><input type="hidden" name="id" value="<%=info_id%>"/></td>
					<td align="center"><input type="text" id="key<%=info_id%>" name="key" 
										value="<%=info_key%>" class="required" maxlength="255" style="width:120px"/>
					</td>
					<td align="center"><input type="text" id="value<%=info_id%>" name="value" 
										value="<%=info_value%>" class="required" maxlength="255" style="width:500px"/>
					</td>
					<td align="center">
						<input type="checkbox" 
							id="checkbox<%=info_id%>" 
						...
						<input type="hidden" id="disabled<%=info_id%>>" name="disabled" value="false"/>
					</td>
					<td align="center"><a href="deleteSysInfo.do?id=<%=info_id%>&idList=null" onclick="if(!confirm('您确定删除吗？')) {return false;}" class="pn-opt">删除</a></td>
				</tr>
			<%
			}
			%>
