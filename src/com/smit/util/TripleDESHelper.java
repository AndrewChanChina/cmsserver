...
public class TripleDESHelper {
	...
	//3des ebc模式加密
	public TripleDESHelper(String key,String mode){
		ebs64 = new BASE64Encoder();
		dbs64 = new BASE64Decoder();
		this.key = key;
		try{
	...
	public String ebcDecode(String encodeText){
		String str = null;
		try{
			SecretKeySpec keySpec = new SecretKeySpec(key.getBytes(), "TripleDES");
			ci.init(Cipher.DECRYPT_MODE, keySpec);
			byte[] s = dbs64.decodeBuffer(encodeText);
			byte[] b = ci.doFinal(s);
			str = new String(b);
		}catch (Exception e){
...
//		}
		String s1 = "15830001123457011a2b334567a62011";
		TripleDESHelper helper2 = new TripleDESHelper("123456789ABCDEFGHIJKLMNO","ecb");
		String s2 = helper2.ebcEncode(s1);
		System.out.println(s2);
		System.out.println(helper2.ebcDecode(s2));
	}
}
