...
public class ClockDaoImpl extends HibernateDaoSupport implements ClockDao {
	...
	public List<Clock> listAll(final SmitPage page) {
		...
		List count = getHibernateTemplate().find("SELECT count(*) FROM com.smit.vo.alarmclock.Clock");
	...
	private List listAll(){
		return this.getHibernateTemplate().find("SELECT g FROM com.smit.vo.alarmclock.Clock g");
	}
